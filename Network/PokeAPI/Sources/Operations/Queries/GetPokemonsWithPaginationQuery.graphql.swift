...
public class GetPokemonsWithPaginationQuery: GraphQLQuery {
  public static let operationName: String = "GetPokemonsWithPagination"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query GetPokemonsWithPagination($first: Int!) { pokemons(first: $first) { __typename ...PokemonDetails } }"#,
